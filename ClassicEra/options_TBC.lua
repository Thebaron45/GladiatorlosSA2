...
if loc == "enUS" or loc == "enGB" then
    ...
    L["Alert works anywhere else then anena, BG, dungeon instance"] = "Alerts occur in the world, such as Kalimdor, Eastern Kingdoms, or Outland."
elseif loc == "frFR" then
    L["Alert only works in arena"] = "Les alertes se produisent en arène."
    L["epicbattleground"] = "Vallée d’Alterac"
    L["epicbattlegroundDesc"] = "Les alertes se produisent dans la vallée d’Alterac."
    L["Alert works anywhere else then anena, BG, dungeon instance"] = "Les alertes se produisent dans le monde, comme Kalimdor, les Royaumes de l’Est ou l’Outreterre."
elseif loc == "koKR" then
    L["Alert only works in arena"] = "투기장에서 알림이 발생합니다."
    L["epicbattleground"] = "알터랙 계곡"
    L["epicbattlegroundDesc"] = "알터랙 계곡에서 알림이 발생합니다."
    L["Alert works anywhere else then anena, BG, dungeon instance"] = "칼림도어, 동부 왕국 또는 아웃랜드와 같은 야외 지역에서 알림이 발생합니다."
elseif loc == "ruRU" then
    L["Alert only works in arena"] = "Оповещения работают на аренах."
    L["epicbattleground"] = "Альтеракская долина"
    L["epicbattlegroundDesc"] = "Оповещения работают в Альтеракской долине."
    L["Alert works anywhere else then anena, BG, dungeon instance"] = "Оповещения работают в мире, например в Калимдоре, Восточных королевствах или Запределье."
elseif loc == "zhCN" then
    L["Alert only works in arena"] = "在竞技场中触发警报。"
    L["epicbattleground"] = "奥特兰克山谷"
    L["epicbattlegroundDesc"] = "在奥特兰克山谷中触发警报。"
    L["Alert works anywhere else then anena, BG, dungeon instance"] = "在卡利姆多、东部王国或外域等世界区域中触发警报。"
elseif loc == "zhTW" then
    L["Alert only works in arena"] = "在競技場中觸發警報。"
    L["epicbattleground"] = "奧特蘭克山谷"
    L["epicbattlegroundDesc"] = "在奧特蘭克山谷中觸發警報。"
    L["Alert works anywhere else then anena, BG, dungeon instance"] = "在卡林多、東部王國或外域等世界區域中觸發警報。"
end
